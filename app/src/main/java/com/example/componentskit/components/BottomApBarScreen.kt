...
fun BottomAppBarScreen(navController: NavHostController){
    ...
    val pages = listOf("Home","Search","Perfil")
    val colorPages = listOf(Color.Red, Color.Green, Color.Blue)
                   ...
                   horizontalArrangement = Arrangement.SpaceAround,
                    ...
                    IconButton(onClick = {
                        ...
                        Icon(imageVector = Icons.Default.Home,
                            ...
                            tint = if(pageSelected == 0) Color.Red else Color.Gray
                        )
                    ...
                    IconButton(onClick = {
                        ...
                        Icon(imageVector = Icons.Default.Search,
                            ...
                            tint = if(pageSelected == 1) Color.Green else Color.Gray
                        )
                    }
                    IconButton(onClick = {
                        pageSelected = 2
                        ...
                        Icon(imageVector = Icons.Default.AccountCircle,
                            ...
                            tint = if(pageSelected == 2) Color.Blue else Color.Gray
                        )
